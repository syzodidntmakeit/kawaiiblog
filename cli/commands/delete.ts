    ...
    try {
        ...
        const answers = await inquirer.prompt([
            ...
            },
            {
                type: 'confirm',
                name: 'confirmDelete',
                message: (answers) => `Are you sure you want to delete "${answers.postFolder}"? This cannot be undone.`,
                default: false,
            }
        ]);
        ...
        spinner.succeed(chalk.green(`Post "${answers.postFolder}" deleted successfully!`));
