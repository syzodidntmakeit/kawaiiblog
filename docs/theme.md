...
- **Tone:** "No-bullshit", authentic, slightly edgy but playful.
  - _Example Copy:_ "All wrongs reserved.", "Don't be a bitch." (Footer)
  - _Keywords:_ Authentic, Direct, Cozy, Dark.
...
- **Primary Font:** `'Nunito', sans-serif` (Google Fonts).
  ...
  - _Vibe:_ Rounded, friendly, modern. Balances the "edgy" dark theme.
- **Secondary/Code Font:** `'VT323', monospace` (Imported).
  - _Potential Use:_ Retro/Terminal style accents (though primarily Nunito is observed in active UI).
